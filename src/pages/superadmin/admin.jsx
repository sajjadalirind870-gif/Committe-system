...
//                 <div>
//                   <h2 className='text-2xl font-bold text-blue-900'>Create Admin</h2>
//                   <p className='text-gray-400 text-sm'>Create a new admin account</p>
//                 </div>
//                 <button 
...
//                   className='w-full border border-gray-300 rounded-lg px-4 py-2 my-2 focus:outline-none focus:ring-2 focus:ring-blue-400'
//                 />
//                 {error?.name && <p className='text-red-500 text-sm'>{error.name}</p>}

//                 <input type="email" name='email' value={adminData.email}
//                   placeholder='Email Address' onChange={handleChange}
//                   className='w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 my-2'
//                 />
...
//                 <input type="password" name='confirmPassword' value={adminData.confirmPassword}
...
//                     className='w-full border border-gray-300 text-gray-600 py-2 rounded-lg hover:bg-gray-50 transition font-medium'>
//                     Cancel
//                   </button>
...
//                   <th className='px-4 py-3 text-blue-900'>Name</th>
//                   <th className='px-4 py-3 text-blue-900'>Email</th>
//                   <th className='px-4 py-3 text-blue-900'>Status</th>
//                   <th className='px-4 py-3 text-blue-900'>Actions</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {admins.map((admin) => (
...
//                         <button onClick={() => blockAdmin(admin.id)}
//                           className={`px-3 py-1 rounded-lg text-white text-sm transition
//                             ${admin.status === 'active' ? 'bg-blue-500 hover:bg-blue-600' : 'bg-green-500 hover:bg-green-600'}`}>
...
//             </table>
//             {admins.length === 0 && (
//               <p className='text-center text-gray-400 py-6'>No admins created yet</p>
//             )}
//           </div>
//         </div>
