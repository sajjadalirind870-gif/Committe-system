...
//         })
//         setGroupData({ name:'', maxMembers:'', dailyPayment:'', cycleDays:'', members:[], status:'' })
//     }
...
//   {isOpen && (
//     <div className='flex items-center fixed bg-black/40 backdrop-blur-sm inset-0  z-50 w-full '>
//             {/* Form Card */}
//                 <div className='bg-white rounded-xl shadow p-6 mb-8 w-full max-w-2xl mx-auto'>
// <div className='flex items-center justify-between'>
//     <div>
//                             <h2 className='text-2xl font-bold text-blue-900 mb-1'>Create Group</h2>
//                     <p className='text-gray-400 text-sm mb-6'>Create New Committe Group</p>
//     </div>
//     <button onClick={() => setIsOpen(!isOpen)} className='mb-12 text-xl'>X</button>
// </div>
                    
//                     <form onSubmit={handleSubmit} className='flex flex-col gap-3 w-full'>
//                         <input 
//                             type="text" name='name' value={groupData.name} 
//                             onChange={handleChange} placeholder='Group Name'
//                             className='w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400'
//                         />
//                         <input 
//                             type="number" name='maxMembers' value={groupData.maxMembers} 
//                             onChange={handleChange} placeholder='Max Members (e.g. 10)'
//                             className='w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400'
//                         />
//                         <input 
//                             type="number" name='dailyPayment' value={groupData.dailyPayment} 
//                             onChange={handleChange} placeholder='Daily Payment (e.g. 100)'
//                             className='w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400'
//                         />
//                         <input 
//                             type="number" name='cycleDays' value={groupData.cycleDays} 
//                             onChange={handleChange} placeholder='Cycle Days (e.g. 10)'
//                             className='w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400'
//                         />
//                       <div className='flex  items-center justify-between gap-3'>
//                       <button onClick={() => setIsOpen(false)} className='bg-gray-600 hover:bg-gray-700 text-white py-2  rounded-lg font-medium w-full mt-2'>Cancel</button>
//                           <button className='bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition font-medium mt-2 w-full'>
//                             Create Group
//                         </button>
//                       </div>
//                     </form>
...
//                         Groups List ({myGroups.length})
//                     </h2>
//                     <div className='relative'>
//                     <FaSearch className='absolute top-6 right-36'/>
//                     <input type="text" value={search} placeholder='Search Group' onChange={(e) => setSearch(e.target.value)}  className='border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-600 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-300 mr-2'/>
//                     <button onClick={() => setIsOpen(!isOpen)} className='py-2 px-4 my-3 rounded-lg bg-blue-600 text-white'>Create Group</button>
//                     </div>
//                   </div>
//                     <table className='w-full text-left'>
//                         <thead>
//                             <tr className='bg-blue-50'>
//                                 <th className='px-4 py-2 text-blue-900'>Name</th>
//                                 <th className='px-4 py-2 text-blue-900'>Max Members</th>
//                                 <th className='px-4 py-2 text-blue-900'>Daily Pay</th>
//                                 <th className='px-4 py-2 text-blue-900'>Cycle Days</th>
//                                 <th className='px-4 py-2 text-blue-900'>Status</th>
//                                 <th className='px-4 py-2 text-blue-900'>Action</th>
//                             </tr>
//                         </thead>
//                         <tbody>
...
//                                     <td className='px-4 py-2'>Rs. {group.dailyPayment}</td>
//                                     <td className='px-4 py-2'>{group.cycleDays} Days</td>
//                                     <td className={group.status === 'pending' ? 'px-4 py-2 text-yellow-500 font-semibold' : 'px-4 py-2 text-green-500 font-semibold'}>
//                                         {group.status}
//                                     </td>
...
//                                         <button onClick={() => startGroup(group.id)} className='bg-blue-500 text-white px-3 py-1 rounded-lg text-sm hover:bg-blue-600' disabled={group.status !== 'pending'}>
//                                         Start Group
//                                         </button>
//                                      {   console.log(group)}
...
//                     </table>
//                     {groups.length === 0 && (
//                         <p className='text-center text-gray-400 py-4'>There is no group right now</p>
//                     )}
//                 </div>
